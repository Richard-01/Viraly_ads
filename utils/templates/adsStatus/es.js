export const esTemplate = ({ status, body = "" }) => {
  return `
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-m-txt-c">
                                                                                        <h2 style="color: #48687f; line-height: 100%; font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif; text-align: center; font-size: 27px;"><strong>Sistema de anuncios</strong></h2>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text" bgcolor="#ffffff">
                                                                                        <p style="font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif; font-size: 16px; color: #000000;">Ha finalizado el proceso de extracción de anuncios. A continuación, se presenta el estado final del procesamiento de anuncios.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text" esd-links-underline="underline" esd-links-color="#0b5394">
                                                                                        <p style="font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif; font-size: 16px; color: #000000;">${body}</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
